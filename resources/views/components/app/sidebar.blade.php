        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1 small">Daftar Kegiatan KKN</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('jenis.kkn') ? 'active' : '' }}" href="{{ route('jenis.kkn') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i class="fas fa-list"></i>
                    </div>
                    <span class="nav-link-text ms-1 small">Jenis KKN</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('users-management') ? 'active' : '' }}" href="{{ route('users-management') }}">
                    ...
                    <span class="nav-link-text ms-1 small">Panitia</span>
                </a>
            </li>
            @if (Route::has('login'))
            <li class="nav-item">
